...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/my_data/fall/mydata.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/my_data/fall/hyp.scratch.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--project', default=ROOT / 'weights/my_models/fall/yolov5/yolov5x/train', help='save to project/name')
