'''
@FileName   :test_AlgorithmApiServer_image.py
@Description:这个py作用相当于前端--不停的发请求
@Date       :2024/03/05 15:59:19
@Author     :daito
...
def objectDetect(filename):
    ...
    url = '%s/image/objectDetect' % backend_host  # 请求地址
    params = {
        "appKey": appKey,
...
if __name__ == '__main__':
    ...
    filename = "E:\\Source\\Github\\Python\\Flask-Projects\\AI-Det-Rec\\AI\\zhd.jpg"
