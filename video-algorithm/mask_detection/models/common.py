...
# from common.util.datasets import exif_transpose, letterbox
from ai_common.util.general import non_max_suppression, make_divisible, scale_coords, increment_path, xyxy2xywh, save_one_box
from ai_common.util.plots import colors, plot_one_box
