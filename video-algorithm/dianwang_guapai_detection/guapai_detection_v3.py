...
from analysis.guapai import process_result_guapai
...
def run_analysis(data):
    ...
    # 接地检测
    img_array_copy = process_result_guapai(pred, data, img, img_array, classes, params)
...
weight_path = './weights/yolov3_ckpt_718.pth'
class_path = './weights/classes_guapai.names'
