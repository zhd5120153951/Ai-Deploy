...
from analysis.leave import process_result_leave
...
def run_analysis(data, update=False):
    ...
    # 图片预处理
    pred_person, names_person, img, img_array, degree = img_preprocess(device, data, MODEL_person, engine, params)
    ...
    # 人员离岗检测
    img_array_copy = process_result_leave(pred_person, names_person, data, img, img_array, params)
