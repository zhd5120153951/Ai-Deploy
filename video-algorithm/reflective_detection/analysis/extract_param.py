class param(object):
    def __init__(self, data):
        ...
        self.conf_thres_reflective = float(data['model_args']['conf_thres_reflective'])
        self.iou_thres_person = float(data['model_args']['iou_thres_person'])
        self.iou_thres_reflective = float(data['model_args']['iou_thres_reflective'])
    ...
    def conf_thres_reflective(self):
        return self.conf_thres_reflective

    def iou_thres_person(self):
        return self.iou_thres_person

    def iou_thres_reflective(self):
        return self.iou_thres_reflective
