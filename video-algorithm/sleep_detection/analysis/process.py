...
def run_process(process_data):
    ...
    for device_args_dict in setting.device_args_list:
        ...
        setting.person_dic[k8s_Name] = {}
        setting.person1_dic[k8s_Name] = {}
        setting.person_img_dic[k8s_Name] = {}
        setting.person_img1_dic[k8s_Name] = {}
        setting.person_frame_dic[k8s_Name] = {}
        setting.frame_t_dic[k8s_Name] = 0
