...
from analysis.helmet import process_result_helmet
...
def run_analysis(data, update=False):
    ...
    # 安全帽检测
    img_array_copy = process_result_helmet(pred, detect_area_flag, names, hide_labels, hide_conf, line_thickness, data, img, img_array, polyline)
